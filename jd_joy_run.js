...
//此处填入你需要助力好友的京东用户名
//下面给出好友邀请助力的示例填写规则
let invite_pins = ["jd_690502342,好人好运气,我就是我的你的他,jd_138149dgz,海人在哪,18915299015_p"];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ["jd_690502342,好人好运气,我就是我的你的他,jd_138149dgz,海人在哪,18915299015_p"];
let temp = run_pins[0].split(',')
let fixPins = temp.splice(temp.indexOf('我就是我的你的他'), 1);
fixPins.push(...temp.splice(temp.indexOf('jd_138149dgz'), 1));
...
let friendsArr = ["jd_690502342","好人好运气","我就是我的你的他","jd_138149dgz","海人在哪","18915299015_p"]
